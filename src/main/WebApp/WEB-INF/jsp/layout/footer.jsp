    ...
    <div id="footer-contacts" class="col-md-12">
      ...
      <div class="col-md-4 pull-right">
        ...
        <p>
          ...
          <br> <i class="icon-envelope"></i> podobri@gmail.com <br> <i class="icon-phone"></i> +359 888 999 911
        </p>
        <p class="social-links">
          <a href="http://facebook.com" target="_blank"> <img alt="Facebook" src="${rootURL}/resources/images/social/fb.png" />
          </a> <a href="http://twitter.com" target="_blank"> <img alt="Twitter"
            src="${rootURL}/resources/images/social/twitter.png" />
          </a> <a href="http://skype.com" target="_blank"> <img alt="Skype" src="${rootURL}/resources/images/social/skype.png" />
