    ...
    <div class="row">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav pull-right">
          ...
          <li><a href="${pageContext.request.contextPath}/organizations"><spring:message code="menuOrganizations" /></a></li>
          ...
          <security:authorize access="isAuthenticated()">
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
              ...
              <ul class="dropdown-menu col-md-12">
                <li><a href="${pageContext.request.contextPath}/users/myProfile"><spring:message code="menuMyProfile" />
                    <span class="glyphicon glyphicon-cog pull-right"></span></a></li>
                <li class="divider"></li>
                <security:authorize access="hasRole('ROLE_ORGANIZATION')">
                  <li><a href="${pageContext.request.contextPath}/events/createEvent"><spring:message
                        code="menuCreateEvent" /><span class="glyphicon glyphicon-plus pull-right"></span></a></li>
                  <li class="divider"></li>
                ...
                <security:authorize access="hasRole('ROLE_INDIVIDUAL')">
                  <li><a href="${pageContext.request.contextPath}/events/createInitiative"><spring:message
                        code="menuCreateInitiative" /><span class="glyphicon glyphicon-plus pull-right"></span></a></li>
                  <li class="divider"></li>
                </security:authorize>
                <%-- 								<li><a href="#"><spring:message code="menuMessages" /> <span class="badge pull-right"> 12 </span></a></li> --%>
                <!-- 								<li class="divider"></li> -->
                <li><a href="${pageContext.request.contextPath}/j_spring_security_logout"><spring:message
                      code="menuSignOut" /> <span class="glyphicon glyphicon-log-out pull-right"></span></a></li>
              </ul></li>
          </security:authorize>
          <security:authorize access="isAnonymous()">
            <li><a data-toggle="modal" data-target="#login" href=""> <%-- 						<a href="${pageContext.request.contextPath}/login"> --%>
                <spring:message code="menuSignIn" /> <span class="glyphicon glyphicon-log-in pull-left"></span></a></li>
          </security:authorize>
          <li><a href="?lang=en"> <img alt="<spring:message code="menuLanguageEn" />"
              src="${rootURL}/resources/images/en.png" /></a></li>
          <li><a href="?lang=bg"> <img alt="<spring:message code="menuLanguageBg" />"
              src="${rootURL}/resources/images/bg.png" /></a></li>
        </ul>
      </div>
    </div>
  </div>
