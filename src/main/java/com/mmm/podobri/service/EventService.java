...
public interface EventService extends BaseDaoServices<Event>
{
    ...
    { 
        ...
        public static String getStatusName(byte status)
        {
            switch (status)
            {
                case 0: return NEW.name();
                case 1: return INCOMING.name();
                case 2: return PAST.name();
                case 3: return INPROGRESS.name();
                case 4: return REJECTED.name();
                case 5: return FAILED.name();
