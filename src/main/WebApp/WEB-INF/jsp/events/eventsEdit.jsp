			...
			<div id="createEvent" class="col-md-10">
				<div class="row">
					<div id="createEventTitle">
						<h3>
							<strong>Редактиране на събитие</strong>
						</h3>
					</div>
				</div>
							...
							<fieldset>
									...
									<c:forEach items="${event.eventsPrograms}" var="eventProgram" varStatus="status">
										<div class='schedule elementWrapper'>
											<div class='form-group col-md-6'>
												<form:label path='eventsPrograms["${status.index}"].subject' class='control-label'>Title</form:label>
												<form:input path='eventsPrograms["${status.index}"].subject' type='text' class='form-control' />
											</div>
											<div class='form-group col-md-3'>
												<form:label path='eventsPrograms["${status.index}"].dateFrom' class='control-label'>Start time</form:label>
											...
											<div class='form-group col-md-12'>
												<form:label path='eventsPrograms["${status.index}"].information' cssClass='control-label'>Description</form:label>
								...
								<div class="row">
									<div class="form-group text-center">
										<button id="createEventSubmit" class="btn btn-success btn-lg" type="submit">ЗАПАЗИ ПРОМЕНИТЕ</button>
									</div>
								</div>
							</fieldset>
						</form:form>
