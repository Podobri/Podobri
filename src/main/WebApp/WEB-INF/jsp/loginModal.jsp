					...
					<div class="panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">
								...
								<a data-toggle="modal" data-target="#register" data-dismiss="modal" aria-hidden="true" href="">
								...
								<div class="row">
									...
									<div id="forgettenPassword">
										<b> <a data-toggle="modal" data-validate="required,alphaNumeric,min(4),max(40)"
											data-target="#forgottenPassword" href=""><spring:message code="forgottenPassword" /></a></b>
									</div>
								</div>
								<br />
