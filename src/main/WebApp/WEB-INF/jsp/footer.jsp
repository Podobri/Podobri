...
<footer>
	...
	<div id="footer-contacts" class="col-md-12">
		<div class="col-md-3 col-md-offset-1">
			<h4>За "По-добри"</h4>
			<p>
				Създадена през 2014 организацията, Sapien augue lobortis nunc, in vehicula ante ante vitae orci. Sed euismod, tellus
				quis commodo suscipit, nisl erat vulputate nunc, aliquam viverra elit nibh a urna. Donec diam lacus, mollis sit amet
				porttitor sed, blandit at lectus. <a href="#">Read more</a>
			</p>
		</div>
		<div class="col-md-3 col-md-offset-1">
		...
		<div class="col-md-3 col-md-offset-1">
			...
			<p>
				Сдружение "По-добри"<br>
				<i class="icon-map-marker"></i> ул. Васил Левски 21, София 1000 <br>
				<i class="icon-envelope"></i> podobri@gmail.com <br>
