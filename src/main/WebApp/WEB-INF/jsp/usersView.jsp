					...
					<div id="notifications">
						...
						<div class="notify row">
							<div class="notify-left col-md-2 center">
								<a href=""> <img class="img-circle" alt="" src="${imgURL}/profile.png">
								</a>
							</div>
						...
						<div class="notify row">
							<div class="notify-left col-md-2 center">
								<a href=""> <img class="img-circle" alt="" src="${imgURL}/profile_exit.png">
								</a>
							</div>
							<div class="notify-right col-md-10">
						...
						<div class="notify row">
							<div class="notify-left col-md-2 center">
								<a href=""> <img class="img-circle" alt="" src="${imgURL}/register_user.png">
								</a>
							</div>
							<div class="notify-right col-md-10">
