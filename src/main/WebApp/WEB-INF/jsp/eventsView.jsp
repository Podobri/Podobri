...
<div id="eventViewFull" class="container">

  <div class="row">
    <div id="eventViewFullContent" class="col-md-10">
      <div class="row">
        <div class="col-md-10">
          <div class="row">
          ...
          <div class="row">
            <div id="eventViewFullMenuContent" class="tab-content">
              ...
              <div id="aboutEvent" class="tab-pane fade in active">
                <p><span>Изисквания към кандидатите: </span> няма </p>
                <p><span>Разходи за събитието:</span> непоети</p>
                <p><span>Организатор:</span> <u>Podobri</u></p>
                <p>
                ...
                <p><span>Допълнителна информация:</span> Some sample text</p>
              </div>

              <div id="eventProgram" class="tab-pane fade">
                <div id="eventProgramContent">
                  <p><span>Програма</span></p>
                ...
                <div id="eventProgramInfo">
                  <p><span>Допълнителна информация:</span></p>
                  <p>
                    This is some sample text. This is some sample text.This is some sample text. This is some sample text.
                    This is some sample text. This is some sample text.This is some sample text. This is some sample text.
                    This is some sample text. This is some sample text.This is some sample text. This is some sample text.
              ...
              <div id="eventLectors" class="tab-pane fade">
                ...
                <div id="lector2" class="eventLector">
                  <div class="media">
                  <a class="pull-left" href="#">
                    <?php echo $this->Html->image("team2.jpg"); ?>
                  </a>
                  <div class="media-body">
                    ...
                    <p><span>личен блог:</span> <a href="#">somerandomblog.blogsport.com </a></p>
                  </div>
                </div>
                </div>
