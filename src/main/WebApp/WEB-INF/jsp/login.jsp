...
<body>
  <div class="container">
    ...
    <div id="content">
      <div id="login-form-content" class="col-md-6 col-md-offset-3">
        <h3 class="thin text-center">
          <spring:message code="loginTitle" />
        </h3>
        <p class="text-center text-muted">
          <span> <spring:message code="noProfile" />
          </span><a href="${pageContext.request.contextPath}/users/register"><spring:message code="register" /></a>.
        </p>
        ...
        <form method="post" action="${pageContext.request.contextPath}/j_spring_security_check?targetUrl=${targetUrl}">
          ...
          <div class="row">
            ...
            <div id="forgetten-password">
              <b> <a data-toggle="modal" data-validate="required,alphaNumeric,min(4),max(40)" data-target="#forgottenPassword"
                href=""><spring:message code="forgottenPassword" /></a></b>
            </div>
          </div>
          <br />
