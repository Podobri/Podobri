...
<body>
  <div class="container">
    ...
    <div id="content">
      <div id="user-profilepage" class="col-md-10">
        <div class="row">
          <div id="user-profile-page-title">
            <h3>
        ...
        <div class="row">
          <div id="page-welcome" class="center col-md-12">
            <h1 class="pull-down">
        ...
        <div class="row">
          <div id="event-view-full-menu" class="menu-tabs">
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#profile-my-notifications"><span><spring:message
                      code="newsAndNotifies" /></span></a></li>
              <li><a data-toggle="tab" href="#profile-edit"><span><spring:message code="profileEdit" /></span></a></li>
              <li><a data-toggle="tab" href="#change-password"><span><spring:message code="changePassword" /></span></a></li>
              <li><a data-toggle="tab" href="#profile-my-events"><span><spring:message code="menuMyEvents" /></span></a></li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div id="profile-content" class="tab-content">
            <div id="profile-my-notifications" class="tab-pane fade in active">
            ...
            <div id="profile-edit" class="tab-pane fade col-md-12">
              <div class="row">
                <div class="register-user-inputs ">
                  <form:errors path="user.*" />
                  <form:form id="register-individual-form" modelAttribute="user" method="post"
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          <form:select id="city" path="userInfo.city.id" cssClass="form-control">
                            <form:option id="city-none" value="-1">---<spring:message code="city" />---</form:option>
            ...
            <div id="change-password" class="tab-pane fade col-md-8">
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <input id="old-password" type="password" placeholder="${oldPassPlaceholder }" required="required"
                    class="form-control" /> <input id="new-password" type="password" placeholder="${newPassPlaceholder }"
                    required="required" class="form-control" /> <input id="re-new-password" type="password"
